...
def main():
    ...
    val_loader = DATASET.get_val_loader(txt=args.txt)

    # create model
    print("=> creating denoising-diffusion model with wrapper...")
    diffusion = DenoisingDiffusion(args, config, phase="Val")
    model = DiffusiveRestoration(diffusion, args, config)
    model.restore(val_loader, temp_blend=args.tb, r=args.grid_r)
